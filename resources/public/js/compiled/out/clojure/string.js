...
{{
var G__18055 = cljs.core.pop.call(null,v__$1);
v__$1 = G__18055;
continue;
}
} else
...
{var pred__18059 = cljs.core._EQ_;var expr__18060 = limit;if(cljs.core.truth_(pred__18059.call(null,(1),expr__18060)))
...
var G__18062 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__18063 = (limit__$1 - (1));
var G__18064 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__18062;
limit__$1 = G__18063;
parts = G__18064;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___18066 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___18066))
{var replacement_18067 = temp__4124__auto___18066;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_18067)));
} else
{buffer.append(ch);
}
{
