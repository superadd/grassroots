...
{{
var G__16727 = cljs.core.pop.call(null,v__$1);
v__$1 = G__16727;
continue;
}
} else
...
{var pred__16731 = cljs.core._EQ_;var expr__16732 = limit;if(cljs.core.truth_(pred__16731.call(null,1,expr__16732)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__16731.call(null,2,expr__16732)))
...
var G__16734 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__16735 = (limit__$1 - 1);
var G__16736 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__16734;
limit__$1 = G__16735;
parts = G__16736;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___16738 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___16738))
{var replacement_16739 = temp__4090__auto___16738;buffer.append([cljs.core.str(replacement_16739)].join(''));
} else
{buffer.append(ch);
}
{
var G__16740 = (index + 1);
index = G__16740;
continue;
}
}
