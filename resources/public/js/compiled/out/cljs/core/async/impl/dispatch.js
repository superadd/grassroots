...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20795 = (0);while(true){
var m_20796 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20796 == null))
{} else
{m_20796.call(null);
if((count_20795 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20797 = (count_20795 + (1));
count_20795 = G__20797;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__10352__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__10352__auto__)
