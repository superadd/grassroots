...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_16557 = 0;while(true){
var m_16558 = cljs.core.async.impl.dispatch.tasks.pop();if((m_16558 == null))
{} else
{m_16558.call(null);
if((count_16557 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__16559 = (count_16557 + 1);
count_16557 = G__16559;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__7789__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__7789__auto__)
