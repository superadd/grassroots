...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__8368__auto__,writer__8369__auto__,opt__8370__auto__){return cljs.core._write.call(null,writer__8369__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_16522 = 0;while(true){
if((i_16522 < arr.length))
{(arr[i_16522] = null);
{
var G__16523 = (i_16522 + 1);
i_16522 = G__16523;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__8368__auto__,writer__8369__auto__,opt__8370__auto__){return cljs.core._write.call(null,writer__8369__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_16529 = (self__.level + 1);while(true){
if((i_16529 <= (new_level + 1)))
{(update[i_16529] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_16531 = 0;while(true){
if((i_16531 <= self__.level))
{var links_16532 = (update[i_16531]).forward;if(((links_16532[i_16531]) === x__$1))
{(links_16532[i_16531] = (x__$1.forward[i_16531]));
{
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__7801__auto__ = (cljs.core.truth_((function (){var and__7789__auto__ = me;if(cljs.core.truth_(and__7789__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__7789__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__7801__auto__))
