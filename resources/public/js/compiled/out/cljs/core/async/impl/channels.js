...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20801 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20801 = (function (val,box,meta20802){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20801.cljs$lang$type = true;
cljs.core.async.impl.channels.t20801.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20801";
cljs.core.async.impl.channels.t20801.cljs$lang$ctorPrWriter = (function (this__10931__auto__,writer__10932__auto__,opt__10933__auto__){return cljs.core._write.call(null,writer__10932__auto__,"cljs.core.async.impl.channels/t20801");
});
cljs.core.async.impl.channels.t20801.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20801.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20803){var self__ = this;
var _20803__$1 = this;return self__.meta20802;
});
cljs.core.async.impl.channels.t20801.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20803,meta20802__$1){var self__ = this;
var _20803__$1 = this;return (new cljs.core.async.impl.channels.t20801(self__.val,self__.box,meta20802__$1));
});
cljs.core.async.impl.channels.__GT_t20801 = (function __GT_t20801(val__$1,box__$1,meta20802){return (new cljs.core.async.impl.channels.t20801(val__$1,box__$1,meta20802));
});
}
return (new cljs.core.async.impl.channels.t20801(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__10934__auto__,writer__10935__auto__,opts__10936__auto__){return cljs.core._write.call(null,writer__10935__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__10931__auto__,writer__10932__auto__,opt__10933__auto__){return cljs.core._write.call(null,writer__10932__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_20804 = self__.takes.pop();if((taker_20804 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20804))
{var take_cb_20805 = cljs.core.async.impl.protocols.commit.call(null,taker_20804);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20805,taker_20804,this$__$1){
return (function (){return take_cb_20805.call(null,null);
});})(take_cb_20805,taker_20804,this$__$1))
);
} else
{}
{
