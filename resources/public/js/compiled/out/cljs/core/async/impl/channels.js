...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t16563 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t16563 = (function (val,box,meta16564){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t16563.cljs$lang$type = true;
cljs.core.async.impl.channels.t16563.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t16563";
cljs.core.async.impl.channels.t16563.cljs$lang$ctorPrWriter = (function (this__8368__auto__,writer__8369__auto__,opt__8370__auto__){return cljs.core._write.call(null,writer__8369__auto__,"cljs.core.async.impl.channels/t16563");
});
cljs.core.async.impl.channels.t16563.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t16563.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_16565){var self__ = this;
var _16565__$1 = this;return self__.meta16564;
});
cljs.core.async.impl.channels.t16563.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_16565,meta16564__$1){var self__ = this;
var _16565__$1 = this;return (new cljs.core.async.impl.channels.t16563(self__.val,self__.box,meta16564__$1));
});
cljs.core.async.impl.channels.__GT_t16563 = (function __GT_t16563(val__$1,box__$1,meta16564){return (new cljs.core.async.impl.channels.t16563(val__$1,box__$1,meta16564));
});
}
return (new cljs.core.async.impl.channels.t16563(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__8371__auto__,writer__8372__auto__,opts__8373__auto__){return cljs.core._write.call(null,writer__8372__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__8368__auto__,writer__8369__auto__,opt__8370__auto__){return cljs.core._write.call(null,writer__8369__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_16566 = self__.takes.pop();if((taker_16566 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_16566))
{var take_cb_16567 = cljs.core.async.impl.protocols.commit.call(null,taker_16566);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_16567,taker_16566){
return (function (){return take_cb_16567.call(null,null);
});})(take_cb_16567,taker_16566))
);
} else
{}
{
